...
//   #warning Using ESP8266 WiFi for ESP8266 in ws_common.hpp
  ...
  #define WSDefaultSecuredTcpClient websockets2_generic::network2_generic::SecuredEsp8266TcpClient
    ...
    // #define PLATFORM_DOES_NOT_SUPPORT_BLOCKING_READ
    #include <Tiny_Websockets_Generic/network/uno_r4_wifi/uno_r4_tcp.hpp>
	#define WSDefaultTcpClient websockets2_generic::network2_generic::UnoR4WiFiTcpClient
    #ifndef _WS_CONFIG_NO_SSL
		  // OpenSSL Dependent
		  #define WSDefaultSecuredTcpClient websockets2_generic::network2_generic::SecuredUnoR4WiFiTcpClient
		#endif //

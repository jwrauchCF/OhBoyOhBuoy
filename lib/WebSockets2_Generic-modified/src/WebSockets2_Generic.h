/****************************************************************************************************************************
    ...
    This library is provided only as a convenience to enable Websocket client connectivity with ChipChopEngine.io and to work in conjunction with the ChipChop Arduino Library

    If you need to use a different type of board than ESP32/8266 you can find the full version of this library at: https://github.com/khoih-prog/WebSockets2_Generic/
    -------------------------------------

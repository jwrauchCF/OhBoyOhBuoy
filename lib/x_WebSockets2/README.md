## Version Notes
26/01/2023 - Modified by ChipChop Gizmo
This is a cut-down modified version of the "WebSockets2_Generic" Library optimised only for ESP32 & ESP8266 boards.
This library is provided only as a convenience to enable Websocket client connectivity with https://ChipChopEngine.io and to work in conjunction with the ChipChop Arduino Library

If you need to use a different type of board than ESP32/ESP8266 & UNO R4 Wifi you can find the full version of this library at: https://github.com/khoih-prog/WebSockets2_Generic/

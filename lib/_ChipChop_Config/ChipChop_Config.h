...
#define WIFI_PORTAL_CONNECTED 8
#define WIFI_PORTAL_DISCONNECTED 9
#define WIFI_PORTAL_ERROR 10
//events
#define WIFI_PORTAL_STATUS 1
#define WIFI_PORTAL_TOTAL_EVENTS 1
#define WIFI_PORTAL_TOTAL_CALLBACKS 4
//settings
#define WIFI_PORTAL_HOTSPOT_SSID "Comrade Motor 1"
#define WIFI_PORTAL_HOTSPOT_PASSWORD ""
#define WIFI_PORTAL_CONNECT_TO "ANY_KEEP_PREFERED"
#define WIFI_PORTAL_RECONNECT_INTERVAL 30000
#define WIFI_PORTAL_TIMEOUT 180000
#define WIFI_PORTAL_AUTO_RECONNECT 1
#define WIFI_PORTAL_CUSTOM_HOSTNAME "Comrade Motor 1"
#define WIFI_PORTAL_USE_MDNS 1
#define WIFI_PORTAL_MDNS_DOMAIN_NAME "Comrade-Motor-1"

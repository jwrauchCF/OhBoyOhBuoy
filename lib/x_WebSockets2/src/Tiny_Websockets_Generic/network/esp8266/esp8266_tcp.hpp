      ...
      public:
        ...
        TcpClient* accept() override 
        {
          while (available()) 
          {
            ...
            // auto client = server.available(); //<<<< uncommenting this line and commenting below will compile ok but can produce warnings
            auto client = server.accept(); //<<<< NOTE: if you have a compiler error pointing here uncomment the line above and comment this one, it means that you have an outdated version of the Espressif framework and you should update it
